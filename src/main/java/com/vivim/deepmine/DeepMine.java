...
import com.vivim.deepmine.persistence.JsonProfileRepository;
import com.vivim.deepmine.persistence.MySqlRepository;
...
//        ProfileRepository repository = new JsonProfileRepository(this.getDataFolder());
        repository = new MySqlRepository(this);
        repository.init();
